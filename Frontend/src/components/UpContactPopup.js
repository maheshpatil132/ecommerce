...
function ContactPopUp({ setShowModal, user, setUser, val }) {
    ...
    const handleDelete = () => {
        profile = profile.filter((e) => e._id !== val)
        console.log(profile)
        Axios.put(`/update/${role}/${user._id}`, {
            profileContact: profile
        }).then((req, res) => {
                            ...
                            <div className="flex flex-col bg-[#f4f4f4] p-5 rounded-md">
                                ...
                                <div className="flex justify-around">
                                    <div className="text-end mt-2">
                                        <button onClick={() => { setShowModal(false); handleDelete() }} className='bg-[#de1616] px-3 py-2 mt-4 text-white rounded-md'>Delete profile</button>
                                    </div>
                                    <div className="text-end mt-2">

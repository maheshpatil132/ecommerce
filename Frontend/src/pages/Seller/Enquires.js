...
import ExploreEnquiry from './ExploreEnquiry'
	...
	return (
		<div className=" flex-1">
			...
			<div className="flex flex-col">
				<div ref={content} className=" flex-1 w-[1200px] rounded-md mx-auto p-4 space-y-5 bg-white mt-24">
					<Heading />
				...
				<div className="shadow-xl p-4 w-[1200px] mx-auto mt-6 border bg-[#FFFFFF] rounded-lg">
					<div ref={searchbar} className="sticky top-4 mb-4">
						<SearchBox change={change} />
					</div>

					{bids.filter(bid => bid.quote_status === 'live' || bid.quote_status === 'pending' || bid.quote_status === 'accepted' || bid.quote_status === 'rejected').length > 0 ?
						<div className="brid_box  gap-6 py-4">

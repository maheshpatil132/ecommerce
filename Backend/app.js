...
app.use(cors({
  credentials: true, origin: ['http://localhost:3000', 'https://www.maqure.org', 'https://www.maqure.org', 'https://www.maqure.in' , 'https://maqure.in', 'http://127.0.0.1:5500'], allowedHeaders: ['Content-Type', 'Authorization', 'x-csrf-token'],
}))

...
const { createadmin, loginadmin, aproveseller, rejectseller, addproduct, getallsellerrequest, getalladdprodrequest, adminrejectorder,adminclickprocess, sendrfqadmin, adminupdateprice, getallnewprodrequest, rejectaddproduct  } = require('../controller/AdminController');
...
const RejectProduct = app.put('/reject/addprod',isAutharization , autherizesrole('admin')  , rejectaddproduct )
...
const GetNewProdRequest = app.get('/getall/new/product/request' , isAutharization , autherizesrole('admin') , getallnewprodrequest )
...
module.exports = { CreateAdmin , LoginAdmin , ApproveSeller , RejectSeller , AddProduct , GetAllSellerRequest , GetAllProdRequest ,Rejectorder , Adminclickprocess ,Sendrfqadmin ,Adminupdateprice ,GetNewProdRequest , RejectProduct}
